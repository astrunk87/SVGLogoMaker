...
function rendershape(data) {
  ...
  triangle: `<polygon points="150, 18 244, 182 56, 182" fill="${data.shapeColor}"></polygon><text x="150" y="150" font-size="60" text-anchor="middle" fill=${data.textColor}>${data.characters}</text>`
  }
  // triangle code pulled from hw code for testing triangle shapenpm te
